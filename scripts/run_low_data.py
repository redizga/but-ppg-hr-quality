#!/usr/bin/env python
"""Low-data experiment over nested 25/50/100% train subsets, multiple seeds.

Epic E8 (Both). Stub — implemented in that epic. Kept as a stable entry
...
def main() -> None:
    ...
    parser.parse_args()
    raise NotImplementedError("E8 (Both): implement run_low_data.py")
